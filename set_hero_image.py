...
def resize_and_crop(img_path, dest_path, target_size=(1920, 1143)):
    with Image.open(img_path) as img:
        ...
        # Save as JPG since the template uses .jpg
        img = img.convert("RGB")
...
if __name__ == "__main__":
    ...
    img_dest = r"c:\Users\Harsh\Downloads\lebari-education-html-template-2025-01-26-15-55-45-utc\lebari_django\static\images\main-slider\image-4.jpg"
