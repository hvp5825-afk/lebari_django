...
if __name__ == "__main__":
    ...
    img_src = r"C:\Users\Harsh\.gemini\antigravity-ide\brain\69564934-de77-4300-8f5b-b1adc2491abf\career_change_1781519768361.png"
    img_dest = os.path.join(resource_dir, "news-5.jpg")
